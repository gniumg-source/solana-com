...
Ta sekcja omawia podstawowe koncepcje dotyczące reprezentacji tokenów w sieci
Solana. Po przykłady kodu zajrzyj do sekcji
[Podstawy tokenów SPL](/docs/tokens/basics).
