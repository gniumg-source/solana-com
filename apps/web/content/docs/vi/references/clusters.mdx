...
description:
  ...
  nối với các mạng Solana khác nhau để phát triển, thử nghiệm và triển khai sản
  phẩm.
...
| ------- | -------------------------------- | ------------------------------------ | ------------------------------------ |
| Mainnet | `https://api.mainnet.solana.com` | Môi trường sản xuất thực tế          | Yêu cầu SOL cho các giao dịch        |
| Devnet  | `https://api.devnet.solana.com`  | Thử nghiệm và phát triển công khai   | Airdrop SOL miễn phí để thử nghiệm   |
| Testnet | `https://api.testnet.solana.com` | Thử nghiệm validator và kiểm tra tải | Có thể gặp thời gian ngừng hoạt động |
