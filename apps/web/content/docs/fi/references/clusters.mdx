...
description:
  Tutustu Solanan verkkoklusteri-ympäristöihin (Devnet, Testnet ja Mainnet),
  niiden julkisiin RPC-päätepisteisin, nopeusrajoituksiin ja käyttötapauksiin.
  Opi yhdistämään eri Solana-verkkoihin kehitystä, testausta ja tuotantoa
  varten.
...
| ------------ | -------------------------------- | --------------------------------- | ------------------------------------- |
| Mainnet      | `https://api.mainnet.solana.com` | Live-tuotantoympäristö            | Vaatii SOL:ia transaktioihin          |
...
- Keskeiset erot Devnetin ja Mainnetin välillä:
  ...
  - Devnet ajaa tyypillisesti samaa ohjelmistojulkaisuhaaraversiota kuin Mainnet
    Beta, mutta saattaa ajaa uudempaa minor-julkaisuversiota kuin Mainnet.
- Gossip-aloituspiste Devnetille: `entrypoint.devnet.solana.com:8001`
...
- Testnet ajaa tyypillisesti uudempaa ohjelmistojulkaisuhaaraa kuin sekä Devnet
  että Mainnet
- Gossip-aloituspiste Testnetille: `entrypoint.testnet.solana.com:8001`
...
- Mainnetissä julkaistut tokenit ovat **oikeaa** SOL:ia
- Gossip-aloituspiste Mainnetille: `entrypoint.mainnet.solana.com:8001`

### Mainnet-päätepiste

- `https://api.mainnet.solana.com` - Solana Labsin isännöimä API-solmuklusteri,
  jota tukee kuormantasaaja; nopeusrajoitettu
